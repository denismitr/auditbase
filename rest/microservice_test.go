...
//			Controller:        newMicroservicesController(logger, uuidMock, mrMock).show,
...
//			Target:            "/api/v1/microservices/:id",
//			IsContentTypeJSON: true,
//			Controller:        newMicroservicesController(logger, uuidMock, mrMock).index,
//			Segments:          map[string]string{"id": id},
//		}
//
//		resp := test.Invoke(e, req)
...
//			Body:              body,
//			IsContentTypeJSON: true,
//			Controller:        newMicroservicesController(logger, uuidMock, mrMock).update,
//			Segments:          map[string]string{"id": id},
//		}
//
//		resp := test.Invoke(e, req)
...
//			Body:              body,
//			IsContentTypeJSON: true,
//			Controller:        newMicroservicesController(logger, uuidMock, mrMock).create,
//		}
//
//		resp := test.Invoke(e, req)
//
